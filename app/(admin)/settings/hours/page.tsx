  ...
  useEffect(() => {
    const unsubscribe = subscribeToSettings(TENANT_ID, (data) => {
      if (data?.business_hours) {
        ...
        setOnlyDuringHours((data.business_hours as any).only_during_hours ?? true);
        setAutoRespond((data.business_hours as any).auto_respond_outside ?? false);
  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-gray-400 mt-1">Define when auto replies should send</p>
      </header>
      ...
      <Card className="p-6 space-y-6">
              ...
              <div key={day} className="flex items-center gap-4 pb-4 border-b">
                <div className="w-32">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Label className="font-bold text-white">{dayLabels[index]}</Label>
                  </div>
                </div>
                {dayData.enabled && (
                  <div className="flex items-center gap-2">
        ...
        <div className="space-y-4 pt-4 border-t">
          <div className="flex items-center justify-between">
            <div>
              <Label className="font-bold text-white">Only send AI replies during business hours</Label>
              <p className="text-sm text-gray-400">Disable automatic responses outside of set hours</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <Label className="font-bold text-white">Auto-respond outside hours</Label>
              <p className="text-sm text-gray-400">Send fallback message when offline</p>
            </div>
        ...
        {autoRespond && (
          <div className="space-y-2">
            <Label className="font-bold text-white">Out-of-hours message</Label>
            <Textarea
              rows={3}
